...
def update_excel(df, codes, date, transmittal, date_col, transmittal_col, code_col):
    ...
    # Convert the input date to MM/DD/YYYY string format
...
def main():
    ...
    if uploaded_file is not None:
        try:
            ...
            # Convert existing date columns to MM/DD/YYYY string format
                ...
                if not codes_input:
                    ...
                    if updated_rows > 0:
                        ...
                        with pd.ExcelWriter(output, engine='openpyxl') as writer:
                            # Convert date column to string to avoid datetime issues
                            for col in date_columns:
